...
2) Synthetic_data_generation: Here we used software [Blender](https://www.blender.org/) to create 3D replicas of objects we want to identify. Then, we use YOLO to identify objects in images.
